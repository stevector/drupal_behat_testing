...
then
  ...
  apt-get install -y aufs-tools git mc ssh gawk grep sudo htop mysql-client php5-cli curl php5-curl php5-sqlite postgresql-client postgresql-client-common sqlite3
